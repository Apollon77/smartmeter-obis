...
describe('test StdInTransport with D0 Mode D', function() {

    it('check output of two D0-Mode D messages', function(done){
        this.timeout(600000); // because of first install from npm

        var stdinMock = mock.stdin();
        ...
        setTimeout(function() {
            ...
            var testData = Buffer.from('/SIE32WR5\r\n');
            stdinMock.send(testData);
