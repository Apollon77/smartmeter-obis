...
const obisChannel = {
    ...
    "nl": {
        // 1-127: Meter-specifiek kanaal
        128: "Besparing",
        129: "Ingestelde waarde",
        130: "Voorspelling",
        131: "Maximale grenswaarden werkdag",
        132: "Maximale grenswaarden rustag",
        133: "Minimale grenswaarden werkdag",
        134: "Minimale grenswaarden rustdag",
        135: "SLP maandag",
        136: "SLP dinsdag",
        137: "SLP woensdag",
        138: "SLP donderdag",
        ...
        142: "SLP rustdag",
        143: "Geldbedrag",
        144: "Prognose geldbedrag",
        145: 'CO2-uitstoot',
        146: "Prognose CO2-uitstoot"
    }
};
...
const obisMeasurement = {
    0: { // Abstract Objects
        ...
        "nl": {
            ...
            129: "Status",
            130: "Vochtigheid",
            131: "Lichtintensiteit",
            132: "In bedrijf",
            133: "Aantal stuks",
            96: "Onderhoudsgegevens",
            97: "Fouten",
            98: "Lijsten",
            99: "Dataprofielen, belastingsprofiel P.01/ P.02, logboek P.98/ P.99"
        }
    },
    1: { // Electricity
        'en': {
        ...
        "nl": {
            0: "Algemeen doel",
            1: "Totale werklastenergie afname +",
            2: "Totale werklastenergie teruggave -",
            3: "Totale blindlastenergie afname +",
            4: "Totale blindlastenergie teruggave -",
            5: "Totale blindlastenergie Q I",
            6: "Totale blindlastenergiee Q II",
            7: "Totale blindlastenergie Q III",
            8: "Totale blindlastenergie Q IV",
            9: "Totale schijnbelasting afname +",
            10: "Totale schijnbelasting teruggave -",
            11: "Stroom",
            12: 'Voltage',
            13: "Prestatiefactor",
            14: 'Frequentie',
            16: "Totaalprestatie",
            21: "L1 referentie actieve energie +",
            22: "L1 uitgang van actieve energie -",
            23: "L1-referentie reactieve energie +",
            24: "L1 uitgang reactieve energie -",
            25: "L1 reactieve energie Q I",
            26: "L1 reactieve energie Q II",
            27: "L1 reactieve energie Q III",
            28: "L1 Reactieve energie Q IV",
            29: "L1 schijnbaar vermogen referentie +",
            30: "L1 schijnbaar vermogen -",
            31: "L1 Stroom",
            32: "L1 Spanning",
            33: "L1 Vermogensfactor",
            41: "L2 referentie actieve energie +",
            42: "L2 actieve energie output -",
            43: "L2-referentie reactieve energie +",
            44: "L2 uitgang reactieve energie -",
            45: "L2 reactieve energie Q I",
            46: "L2 reactieve energie Q II",
            47: "L2 reactieve energie Q III",
            48: "L2 reactief vermogen Q IV",
            49: "L2 schijnbaar vermogen referentie +",
            50: "L2 schijnbaar vermogen -",
            51: "L2 Stroom",
            52: "L2 Spanning",
            53: "L2 Vermogensfactor",
            61: "L3-referentie actieve energie +",
            62: "L3-uitgang voor actieve energie -",
            63: "L3-referentie van reactieve energie +",
            64: "L3 uitgang reactieve energie -",
            65: "L3 reactieve energie Q I",
            66: "L3 reactieve energie Q II",
            67: "L3 reactieve energie Q III",
            68: "L3 reactief vermogen Q IV",
            69: "L3 schijnbaar vermogen referentie +",
            70: "L3 schijnbaar vermogen -",
            71: "L3 Stroom",
            72: "L3 Spanning",
            73: "L3 vermogensfactor",
            81: 'Angle',
            82: "Nummer zonder eenheid",
            91: "Neutrale Stroom",
            92: "Neutrale spanning",
            94: "Landspecifiek",
            96: "Onderhoudsgegevens",
            97: "Fout",
            98: "Lijsten",
            99: "Gegevensprofielen, belastingsprofiel P.01/ P.02, bedrijfslogboek P.98/ P.99"
        }
    },
    4: { // Thermal
        'en': {
    ...
    7: { // Gas
        ...
        "nl": {
            128: "operationele kubieke meters",
            129: "Standaard kubieke meter",
            96: "Onderhoudsgegevens",
            97: "Fout",
            98: "Lijsten",
            99: "Gegevensprofielen, belastingsprofiel P.01/ P.02, bedrijfslogboek P.98/ P.99"
    ...
    9: { // Warm water
        ...
        "nl": {
            99: "Drinkwater / koud water voor huishoudelijk gebruik",
            128: "Drinkwater",
            129: "Service water",
            130: "Gedeïoniseerd water",
            96: "Onderhoudsgegevens",
            97: "Fout",
            98: "Lijsten"
        }
...
const obisMeasurementType = {
    1: { // Electricity
        ...
        "nl": {
            0: "Gemiddelde factureringsperiode",

            1: "Cumulatief minimum 1",
            2: "Cumulatief maximum 1",
            3: "Minimum 1",
            4: "Huidig gemiddelde 1",
            5: "Laatste gemiddelde 1",
            6: "Maximum 1",

            7: "Onmiddellijke waarde",
            8: "Tellerstand 1",
            9: 'Feed 2',
            10: 'Time integrale 3',

            11: "Cummulated minimum 2",
            12: "Cumulatief maximum 2",
            13: "Minimum 2",
            14: "Huidig gemiddelde 2",
            15: 'Last mean 2',
            16: 'Maximum 2',

            21: "Cumulatief minimum 3",
            22: "Cumulatief maximum 3",
            23: "Minimum 3",
            24: "Huidig gemiddelde 3",
            25: 'Last mean 3',
            26: 'Maximum 3',

            27: "Huidig gemiddelde 5",
            28: "Huidig gemiddelde 6",
            29: "Belastingscurve",
            30: 'Time integrale 6',

            31: "Onder de limietdrempel",
            32: "Voorvallenteller onder limiet",
            33: "Onder limiet duur",
            34: "Under limit magnitude",

            35: "Over limiet drempel",
            36: "Teller voor voorvallen boven de limiet",
            37: "Overlimiet duur",
            38: "Overgrens magnitude",

            39: "Ontbrekende drempel",
            40: "Ontbrekende voorvalenteller",
            41: "Ontbrekende duur",
            42: "Ontbrekende magnitude",
