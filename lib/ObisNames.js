...
const obisMeasurementCustom = {
    'en': {
        ...
        '6.4':  'Power',
        '6.6':  'Max Power',
        '6.8.1': 'Heat quantity (T1)',
        '6.8.2': 'Supplied or returned heat quantity',
        '6.8.3': 'Cold energy',
        '6.8.4': 'Heat quantity (T2)',
        '6.8.5': 'Heat quantity (T3)',
        '6.26': 'Volume',
        '6.27': 'Flowrate',
        '6.28': 'Temperature return',
        '6.29': 'Temperature flow',
        '6.30': 'Temperature difference',
...
function resolveObisName(obisObj, language) {
    ...
    if (result.customName === '') result.customName = resolveCustomName(obisObj.idToString('base'), language);
    if (result.customName === '') result.customName = resolveCustomName(obisObj.idToString('extended'), language);
